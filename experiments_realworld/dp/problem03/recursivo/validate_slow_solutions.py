#!/usr/bin/env python3
"""
Slow Validation Script para Two Sets II - DP Problem03 Recursivo
...
def run_slow_validation():
    ...
    print("🐌 EXECUTANDO SLOW VALIDATION - Two Sets II Recursivo")
    print("=" * 70)
    
    # Casos críticos baseados nos resultados CSES e benchmark local
    # Focando em casos que demonstram diferenças significativas
    critical_cases = [
        50,   # Caso pequeno-médio
        100,  # Caso de calibração
        150,  # Caso médio
        200,  # Caso onde injustiça aparece
        250,  # Caso crítico
        300   # Caso de alta injustiça
    ]
...
def main():
    """Função principal"""
    print("🐌 SLOW VALIDATION TWO SETS II - DP PROBLEM03 RECURSIVO")
