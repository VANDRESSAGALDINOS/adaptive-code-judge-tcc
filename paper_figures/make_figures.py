...
Gera as figuras do artigo a partir dos dados estruturados (sem inventar numero):
  - paper_figures/realworld_summary.json   (eixo real-world, 11 problemas CSES)
  - experiments/results_summary.json        (eixo teorico, 6 classes)
...
with open(os.path.join(HERE, "realworld_summary.json")) as f:
    RW = json.load(f)["problems"]
with open(os.path.join(ROOT, "experiments", "results_summary.json")) as f:
